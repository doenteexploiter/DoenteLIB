...
local OrionLib = {
	...
	Folder = nil,
	SaveCfg = false,
	Transparency = 0.85, -- Nova propriedade para transparência
	BackgroundImage = nil, -- Asset ID do background
	CustomColors = { -- Cores personalizadas RGB
		Text = nil,
		Stroke = nil
	}
}
...
-- Função de arrasto aprimorada para mobile
local DraggingData = {
	Active = false,
	StartPosition = nil,
...
local function AddDraggingFunctionality(DragPoint, Main)
	pcall(function()
		...
		-- Botão de minimizar customizado para mobile
		local MinimizeBtn = Main:FindFirstChild("TopBar"):FindFirstChild("MinimizeBtn")
		if MinimizeBtn then
			MinimizeBtn.Active = true
			MinimizeBtn.AutoButtonColor = false
			MinimizeBtn.SelectionBehavior = Enum.SelectionBehavior.Selectable
		end
		
		local CloseBtn = Main:FindFirstChild("TopBar"):FindFirstChild("CloseBtn")
		if CloseBtn then
			CloseBtn.Active = true
			CloseBtn.AutoButtonColor = false
			CloseBtn.SelectionBehavior = Enum.SelectionBehavior.Selectable
		end
	end)
end
...
local function AddThemeObject(Object, Type)
	...
	-- Aplicar transparência se for um frame principal
...
-- Função para mudar a transparência
...
-- Função para mudar background por Asset ID
...
function OrionLib:MakeWindow(WindowConfig)
	...
	-- Botão flutuante para abrir/fechar (para mobile)
	...
	-- Mostrar botão flutuante quando UI estiver fechada
	...
	-- Tornar botão flutuante arrastável no mobile
